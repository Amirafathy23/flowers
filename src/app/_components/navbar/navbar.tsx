...
import { useCart } from '@/app/cart/components/CartActions'
...
//session?.data?.user.token? token
  ...
  // console.log('from nav...',session?.data?.user?.role)
  return <>
...
<nav className="bg-slate-100 fixed top-0 start-0 end-0 z-10 border-gray-200 py-2.5 dark:bg-gray-900">
  <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
    ...
    <div className="items-center justify-between w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
      ...
      {session.status === "authenticated"? <>
      {session.data?.user?.role === 'user' ? <> <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
        <li>
        ...
        <li>
          <Link href="/products" className="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-green-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Products</Link>
        </li>
        <li>
        ...
        <li>
          <Link href="/categories" className="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-green-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Categories</Link>
        </li>
        <li>
